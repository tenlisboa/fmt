...
export const AgentState = Annotation.Root({
  ...
  memberGithubUsername: Annotation<string>({
    reducer: (memberGithubUsername, newMemberGithubUsername) =>
      newMemberGithubUsername,
    default: () => "",
  }),
  memberJiraUsername: Annotation<string>({
    reducer: (memberJiraUsername, newMemberJiraUsername) =>
      newMemberJiraUsername,
    default: () => "",
  }),
  repositoryName: Annotation<string>({
    reducer: (repositoryName, newRepositoryName) => newRepositoryName,
    default: () => "",
  }),
